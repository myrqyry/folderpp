...
import { updateControlsFromState, drawFolderIcon, showCanvas, hideCanvas, handleFile, canvas, canvasPlaceholder, canvasOverlay, downloadButton, dropZone, imageInput, fileNameDisplay, resetLoadedImage, resetTransformValues, animateCanvasIn, animateMessageArea } from './dom.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    try {
        console.log('Updating controls from state...');
        updateControlsFromState();
        console.log('✅ Controls updated');
    } catch (e) {
        console.error('❌ Error updating controls:', e.message);
    }
    
    try {
        console.log('Updating custom presets UI...');
        updateCustomPresetsUI();
        console.log('✅ Custom presets UI updated');
    } catch (e) {
        console.error('❌ Error updating custom presets UI:', e.message);
    }
    
    try {
        console.log('Setting up gradient controls...');
        setupGradientControls();
        console.log('✅ Gradient controls setup complete');
    } catch (e) {
        console.error('❌ Error setting up gradient controls:', e.message);
    }
    
    try {
        console.log('Rendering gradient stops UI...');
        ['front', 'back', 'border'].forEach(type => renderGradientStopsUI(type));
        console.log('✅ Gradient stops UI rendered');
    } catch (e) {
        console.error('❌ Error rendering gradient stops UI:', e.message);
    }
    
    try {
        console.log('Initializing shadow controls...');
        setupShadowToggle(); // Use local function instead of importing one
        renderShadowControls();
        console.log('✅ Shadow controls initialized');
    } catch (e) {
        console.error('❌ Error initializing shadow controls:', e.message);
    }
    
    try {
        console.log('Setting up color harmony controls...');
        setupHarmonyControls();
        console.log('✅ Color harmony controls setup complete');
    } catch (e) {
        console.error('❌ Error setting up color harmony controls:', e.message);
    }
    ...
    try {
        ...
        console.error('❌ Error setting up Gemini API controls:', e.message);
    }
    
    try {
        console.log('Drawing folder icon...');
        drawFolderIcon();
        console.log('✅ Folder icon drawn');
    } catch (e) {
        console.error('❌ Error drawing folder icon:', e.message);
    }
    
    try {
        console.log('Initializing collapsible menus...');
        initCollapsibleMenus();
        console.log('✅ Collapsible menus initialized');
    } catch (e) {
        console.error('❌ Error initializing collapsible menus:', e.message);
    }
    try {
        setupMaterialRipple();
        console.log('✅ Material 3 ripple effect enabled');
    } catch (e) {
        console.error('❌ Error setting up ripple effect:', e.message);
    }
    ...
    try {
        ...
        console.error('❌ Error setting up file handling:', e.message);
    }
    ...
    try {
        ...
        console.error('❌ Error setting up control listeners:', e.message);
    }
    
    try {
        console.log('Setting up preset listeners...');
        setupPresetListeners();
        console.log('✅ Preset listeners setup complete');
    } catch (e) {
        console.error('❌ Error setting up preset listeners:', e.message);
    }
    ...
    try {
        ...
        console.error('❌ Error setting up enhanced features:', e.message);
    }
    ...
    try {
        ...
        console.error('❌ Error setting up keyboard shortcuts:', e.message);
    }
    
    // Setup responsive canvas and accessibility
    try {
        ...
        console.error('❌ Error updating canvas size:', e.message);
    }
    ...
    try {
        ...
        console.error('❌ Error enhancing accessibility:', e.message);
    }
    
    console.log('🚀 Advanced folder icon maker loaded with enhanced features!');
    console.log('💡 Keyboard shortcuts:');
    console.log('   Ctrl+S: Save preset');
    console.log('   Ctrl+D: Download');
    console.log('   Ctrl+R: Randomize');
    console.log('   Ctrl+Z: Reset');
    console.log('   Ctrl+C: Copy settings');
    console.log('   Ctrl+V: Paste settings');
    console.log('   1-9: Load preset');
});
