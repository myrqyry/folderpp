...
export function initShadowToggle() {
    console.log('🔧 Initializing shadow toggle functionality...');
    ...
    toggle.addEventListener('change', function shadowToggleHandler(e) {
        ...
        console.log(`🔔 Shadow ${toggle.checked ? 'enabled' : 'disabled'}`);
        saveSettings();
        renderShadowControls();
        drawFolderIcon();
    });
    
    console.log('✅ Shadow toggle initialized successfully');
