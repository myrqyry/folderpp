...
export function showCanvas() {
    ...
    console.log('Canvas hidden class removed, placeholder hidden class added');
}

export function hideCanvas() {
    console.log('hideCanvas called');
    ...
    console.log('Canvas hidden class added, placeholder hidden class removed');
}
